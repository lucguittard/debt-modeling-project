        ...
        dbc.Col(
            html.P(
                [
                    ...
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:lsguittard@gmail..com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/lucguittard/Portfolio-Projects'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/lsguittard/'), 
                ], 
                className='lead'
            )
        )
